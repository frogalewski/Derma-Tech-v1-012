          ...
          <div className="bg-gray-900/40 backdrop-blur-md p-6 sm:p-8 rounded-2xl shadow-lg border border-white/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="lowercase w-full pl-11 pr-4 py-2.5 bg-gray-700/50 text-white placeholder-gray-300 border border-gray-500/50 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition duration-200"
                    required
                  />
                </div>
              </div>
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-gray-200 mb-1">{t('passwordLabel')}</label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-2.5 bg-gray-700/50 text-white placeholder-gray-300 border border-gray-500/50 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition duration-200"
                    required
                  />
                </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-3 px-4 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 disabled:bg-gray-500 disabled:cursor-not-allowed transition-colors duration-200"
              >
                {isLoading ? (
                  <>
            ...
            <p className="mt-6 text-center text-sm text-gray-300">
              {t('noAccountPrompt')}{' '}
              <button onClick={onSwitchToRegister} className="font-medium text-blue-400 hover:text-blue-300 focus:outline-none focus:underline">
                {t('registerNow')}
              </button>
            </p>
          </div>
