...
export const WhatsAppIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2.04C6.5 2.04 2.04 6.5 2.04 12c0 1.8 0.5 3.5 1.4 5l-1.4 5 5-1.4c1.5 0.9 3.2 1.4 5 1.4 5.5 0 9.96-4.46 9.96-9.96S17.5 2.04 12 2.04zM16.5 13.5c-0.3-0.1-1.8-0.9-2.1-1s-0.5-0.1-0.7 0.1c-0.2 0.2-0.8 0.9-1 1.1s-0.4 0.2-0.7 0.1c-0.3-0.1-1.3-0.5-2.5-1.5c-0.9-0.8-1.5-1.8-1.7-2.1c-0.2-0.3 0-0.5 0.1-0.6s0.3-0.4 0.4-0.5c0.1-0.1 0.2-0.3 0.3-0.4s0.1-0.3 0-0.4c-0.1-0.1-0.7-1.7-1-2.3c-0.3-0.6-0.5-0.5-0.7-0.5h-0.7c-0.2 0-0.5 0.1-0.7 0.3c-0.2 0.2-0.8 0.8-0.8 2c0 1.2 0.8 2.3 1 2.5c0.2 0.2 1.6 2.5 4 4.5c0.6 0.5 1 0.8 1.4 1c0.6 0.2 1.1 0.2 1.5 0.1c0.5-0.1 1.5-0.6 1.7-1.2s0.2-1.1 0.1-1.2c-0.1-0.1-0.2-0.2-0.4-0.3z" />
    </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9.93 2.62a1 1 0 0 0-1.86 0L7.05 6.4a1 1 0 0 1-.74.74l-3.78 1.02a1 1 0 0 0 0 1.86l3.78 1.02a1 1 0 0 1 .74.74l1.02 3.78a1 1 0 0 0 1.86 0l1.02-3.78a1 1 0 0 1 .74-.74l3.78-1.02a1 1 0 0 0 0-1.86l-3.78-1.02a1 1 0 0 1-.74-.74Z"/>
        <path d="M18 10h.01"/>
        <path d="M21 13h.01"/>
        <path d="M18 16h.01"/>
        <path d="M14 17.5h.01"/>
